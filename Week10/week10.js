...
function showName(guestName = 'Гость') {
...
function calculateYearsSinceLastOlympics(year, lastOlympicsYear) {
	return (year - lastOlympicsYear);
}
...
function calculateAge(year, friendYearOfBirth) {
	return (year - friendYearOfBirth);
}
console.log("Вам " + calculateAge(2023, friendYearOfBirth) + " лет.");
...
console.log("Вам " + myYear(1977) + " лет.");
...
let calculateDegree = function (a, b) {
	return a ** b;
};
let result1 = calculateDegree(5, 3);
